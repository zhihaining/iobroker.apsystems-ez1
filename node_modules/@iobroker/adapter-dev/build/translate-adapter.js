...
parser
    ...
    .alias("h", "help")
    .alias("v", "version")
    .command(["translate", "t", "$0"], "Translate io-package.json and all admin language files", {
    rebuild: {
        type: "boolean",
        alias: "r",
        default: false,
...
}, (0, util_1.interceptErrors)(translate_adapter_handlers_1.handleTranslateCommand))
    ...
    .command(["remove-translations", "rt"], "Remove translation for a key from all language files except English", {
    key: {
        type: "string",
        alias: "k",
        demandOption: true,
        description: "The translation key to remove from non-English files",
    },
}, (0, util_1.interceptErrors)(translate_adapter_handlers_1.handleRemoveTranslationsCommand))
    .command(["remove-key", "rk"], "Remove a key from all language files including English and words.js", {
    key: {
        type: "string",
        alias: "k",
        demandOption: true,
...
}, (0, util_1.interceptErrors)(translate_adapter_handlers_1.handleRemoveKeyCommand))
    /*
