...
module.exports = (answers => {
    ...
    const template = `
![Logo](admin/${(0, questions_1.getIconName)(answers)})
...
`
            : ""}
`}
1. Head over to ${isAdapter
        ? useTypeScript
            ? "[src/main.ts](src/main.ts)"
            : "[main.js](main.js)"
        : `[widgets/${answers.adapterName}.html](widgets/${answers.adapterName}.html)`} and start programming!
...
## License
${(0, tools_1.getFormattedLicense)(answers)}
`;
